/**
   ...
   https://github.com/ahmadSum1/ESP_OnlineOTA
...
// to connect to
const char* SSID = "TECHCOM-TURBO";
const char* PSWD = "techcomadmin@71";

// S3 Bucket Config
String host = "espota.ahmadsum1.dx.am"; // Host => bucket-name.s3.region.amazonaws.com
int port = 80; // Non https. For HTTPS 443. As of today, HTTPS doesn't work.
String bin = "/FW/Blink.ino.nodemcu-32s.bin"; // bin file name with a slash in front.
